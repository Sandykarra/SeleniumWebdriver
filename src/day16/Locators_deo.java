...
driver.findElement(By.name("email")).sendKeys("javaselenium@gmail.com");
...
System.out.println("The yes button Before isselected(): "+Radiobutton.isSelected()); //false
Radiobutton.click(); //yes 
Thread.sleep(3000); 
//driver.findElement(By.cssSelector("input[value=\"0\"]")).click(); //no button
System.out.println("The yes button After is method selected: "+Radiobutton.isSelected());//false
